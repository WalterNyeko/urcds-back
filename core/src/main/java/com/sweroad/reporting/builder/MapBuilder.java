...
public interface MapBuilder {
    ...
    Map<String, Map<CrashSeverity, Integer>> buildTimeRangeMap(List<Crash> crashes);
    Map<District, Map<CrashSeverity, Integer>> buildDistrictMap(List<Crash> crashes);
    Map<CrashCause, Map<CrashSeverity, Integer>> buildCrashCauseMap(List<Crash> crashes);
    Map<String, Map<CrashSeverity, int[]>> buildCasualtyAgeGenderMap(List<Crash> crashes);
    Map<VehicleType, Map<CrashSeverity, Integer>> buildVehicleTypeMap(List<Crash> crashes);
    ...
    Map<PoliceStation, Map<CrashSeverity, Integer>> buildPoliceStationMap(List<Crash> crashes);

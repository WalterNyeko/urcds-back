...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.sweroad.service.impl.PasswordTokenManager#generateRecoveryToken(com.sweroad.model.User)
     */
    @Override
    ...
    /**
     * @see com.sweroad.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.sweroad.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.sweroad.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override

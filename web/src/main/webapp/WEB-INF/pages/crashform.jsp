...
<div class="col-sm-10">
	<form:form commandName="crash" method="post" action="/crashform2" id="crashform" autocomplete="off" cssClass="well" onsubmit="return validateCrash(this)">
		<div class="col-sm-15">
			<table cellpadding="4" width="100%">
							...
							<tr>
								...
								<td>
						            ...
						            <div class="col-sm-15 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
						               	...
						               	<form:select path="policeStation.id" cssClass="form-control" >
							...
							<tr>
								...
								<td>
						            ...
						            <div class="col-sm-15 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
						                	...
						                	<form:select path="policeStation.district" cssClass="form-control" >
							               		<form:option value=""><fmt:message key="rcds.pleaseSelect"/></form:option>
							...
							<tr>
								<td>
							        ...
							        <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
							            ...
							            <form:input cssClass="form-control" path="crashDateTimeString" id="crashDateTime" autofocus="true"/>
							            <form:errors path="crashDateTimeString" cssClass="help-block"/>
							        </div>
								</td>
							</tr>
							<tr>
					...
					<td>
						<table width="80%" class="crashform-blue">
							...
							<c:forEach var="crashSeverity" items="${crashSeverities}">
								<tr>
									<td>
										<form:radiobutton path="crashSeverity.id" value="${crashSeverity.id}"/>&nbsp;&nbsp;${crashSeverity.name} 
									</td>
								</tr>
							</c:forEach>
						</table>
						...
						<table width="100%" class="crashform-blue">
							...
							<tr>
								<c:forEach var="collisionType" items="${collisionTypes}" varStatus="status">
									...
									<td width="50%">
										<form:radiobutton path="collisionType.id" value="${collisionType.id}"/>&nbsp;&nbsp;${collisionType.name} 
									</td>
								</c:forEach>
							</tr>
						</table>
						...
						<table width="100%" class="crashform-blue">
							...
							<tr>
								<c:forEach var="crashCause" items="${crashCauses}" varStatus="status">
									...
									<td width="33.3%">
										<form:radiobutton path="mainCrashCause.id" value="${crashCause.id}"/>&nbsp;&nbsp;${crashCause.name} 
									</td>
								</c:forEach>
							</tr>
						</table>
						...
						<table width="100%" class="crashform-blue">
							...
							<tr>
								<c:forEach var="vehicleFailureType" items="${vehicleFailureTypes}" varStatus="status">
									...
									<td width="33.3%">
										<form:radiobutton path="vehicleFailureType.id" value="${vehicleFailureType.id}"/>&nbsp;&nbsp;${vehicleFailureType.name} 
									</td>
								</c:forEach>
							</tr>
						</table>
						...
						<table width="100%" class="crashform-gray" cellpadding="0" cellspacing="0">
							<tr>
								<th width="100%" colspan="9">
									<appfuse:label styleClass="control-label" key="crashForm.roadEnvironment"/>
								</th>
							</tr>
							<tr>
								<td width="22%">
									<table width="100%" class="crashform-blue" style="border: none;">
										<tr>
											<th style="border-top: none; border-right: none; border-left: none;">
												<appfuse:label styleClass="control-label" key="crashForm.weather"/>
											</th>
										</tr>
								...
								<td width="22%" colspan="2">
									<table width="100%" class="crashform-blue" style="border: none;">
										<tr>
											<th style="border-top: none; border-right: none; border-left: none;">
												<appfuse:label styleClass="control-label" key="crashForm.surfaceCondition"/>
											</th>
										</tr>
										<c:forEach var="surfaceCondition" items="${surfaceConditions}">
											<tr>
												<td style="border-right: none; border-left: none; border-bottom: none;">
													<form:radiobutton path="surfaceCondition.id" value="${surfaceCondition.id}"/>&nbsp;&nbsp;${surfaceCondition.name} 
												</td>
											</tr>
										</c:forEach>
									</table>
								...
								<td width="4%">&nbsp;</td>
								<td width="22%">
									<table width="100%" class="crashform-blue" style="border-top: none; border-right: none; border-left: none;">
										<tr>
											<th style="border-top: none; border-right: none; border-left: none;">
												<appfuse:label styleClass="control-label" key="crashForm.roadSurface"/>
											</th>
										</tr>
										<c:forEach var="roadSurface" items="${roadSurfaces}">
											<tr>
												<td style="border-right: none; border-left: none;">
													<form:radiobutton path="roadSurface.id" value="${roadSurface.id}"/>&nbsp;&nbsp;${roadSurface.name} 
												</td>
											</tr>
										</c:forEach>
									</table>
								...
								<td width="22%">
									<table width="100%" class="crashform-blue" style="border: none;">
										<tr>
											<th style="border-top: none; border-right: none; border-left: none;">
												<appfuse:label styleClass="control-label" key="crashForm.surfaceType"/>
											</th>
										</tr>
										<c:forEach var="surfaceType" items="${surfaceTypes}">
											<tr>
												<td style="border-right: none; border-left: none; border-bottom: none;">
													<form:radiobutton path="surfaceType.id" value="${surfaceType.id}"/>&nbsp;&nbsp;${surfaceType.name} 
												</td>
											</tr>
										</c:forEach>
									</table>
							...
							<tr>
								<td colspan="3" style="border-right: none;">
									<table width="98%" class="crashform-blue" style="border-top: none; border-left: none; border-bottom: none;">
										<tr>
											<th colspan="2" style="border-top: none; border-left: none;">
												<appfuse:label styleClass="control-label" key="crashForm.roadwayCharacter"/>
											</th>
										</tr>
										<tr>
											<c:forEach var="roadwayCharacter" items="${roadwayCharacters}" varStatus="status">
												<c:if test="${ status.index % 2 == 0 and status.index > 0}">
													</tr><tr>
												</c:if>
												<td width="50%" style="border-left: none; border-bottom: none">
													<form:radiobutton path="roadwayCharacter.id" value="${roadwayCharacter.id}"/>&nbsp;&nbsp;${roadwayCharacter.name} 
												</td>
											</c:forEach>
										</tr>
									</table>
								...
								<td colspan="6" align="right" style="border-left: none;">
									<table width="98%" class="crashform-blue" style="border-top: none; border-right: none; border-bottom: none;">
										<tr>
											<th colspan="3" style="border-top: none; border-right: none;">
												<appfuse:label styleClass="control-label" key="crashForm.junctionType"/>
											</th>
										</tr>
										<tr>
											<c:forEach var="junctionType" items="${junctionTypes}" varStatus="status">
												<c:if test="${ status.index % 3 == 0 }">
													</tr><tr>
												</c:if>
												<td width="33.3%" style="border-right: none; border-bottom: none">
													<form:radiobutton path="junctionType.id" value="${junctionType.id}"/>&nbsp;&nbsp;${junctionType.name} 
												</td>
											</c:forEach>
										</tr>
									</table>
				...
				<tr>
					...
					<td align="right">
						<input type="submit" class="btn btn-primary" value="<fmt:message key='button.next'/>">
					</td>
				</tr>
			</table>
		</div>

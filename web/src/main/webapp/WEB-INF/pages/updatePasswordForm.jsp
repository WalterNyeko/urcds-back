		...
		<form method="post" id="updatePassword"
			...
			<div class="form-group">
				<label class="control-label"><fmt:message
						key="user.username" /></label> <input type="text" name="username"
			...
			<c:choose>
				...
				<c:otherwise>
					<div class="form-group">
						<label class="control-label"><fmt:message
								key="updatePassword.currentPassword.label" /></label> <input
			...
			<div class="form-group">
				<label class="control-label"><fmt:message
						key="updatePassword.newPassword.label" /></label> <input type="password"
